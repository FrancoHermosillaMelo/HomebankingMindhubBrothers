...
//
//			Transaction transaction1 = new Transaction(TransactionType.CREDIT, 1000.58,"Clothes", day,true,account1.getBalance());
//			account1.setBalance(account1.getBalance() - 2500.22);
//			Transaction transaction2 = new Transaction(TransactionType.DEBIT, 2500.22,"Food", day.plusDays(1),true, account1.getBalance());
//			Transaction transaction3 = new Transaction(TransactionType.CREDIT, 957.24,"Cinema", day.plusDays(1),true,account2.getBalance());
//			account2.setBalance(account2.getBalance() - 526.14);
//			Transaction transaction4 = new Transaction(TransactionType.DEBIT, 526.14,"Food", day.plusDays(2),true,account2.getBalance());
