...
public class WebAuthorization {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception{
            ...
            http.authorizeRequests()
                    ...
                    .antMatchers("/main.js").hasAuthority("ADMIN")
                    ...
                    .antMatchers("/api/accounts/transactions/date").hasAnyAuthority("CLIENT", "ADMIN")
                    .antMatchers(HttpMethod.POST, "/api/loans/create").hasAuthority("ADMIN")
                    .antMatchers(HttpMethod.POST,"/api/accounts/transactions/pdf").hasAnyAuthority("CLIENT", "ADMIN")
                    ...
                    .antMatchers(HttpMethod.POST,"/api/loans/pay").hasAnyAuthority("CLIENT", "ADMIN")
